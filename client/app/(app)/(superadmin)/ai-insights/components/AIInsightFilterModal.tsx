...
interface AIInsightFilterModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function AIInsightFilterModal({
  isOpen,
  onClose,
  companyFilter,
  setCompanyFilter,
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-xl w-full max-w-md shadow-lg animate-in fade-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-5 border-b border-gray-200">
          <h2 className="text-lg font-medium text-black">Filter Insights</h2>
          <button
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div>
            <label htmlFor="status-filter" className="block text-sm font-medium mb-2 text-black">Status</label>
            <select
              id="status-filter"
              value={statusFilter}
